...
const settings = drupalSettings.acf_cart !== undefined && drupalSettings.acf_cart.product !== undefined
  ? {
      sku: drupalSettings.acf_cart.product.sku,
      id: drupalSettings.acf_cart.product.id
    }
  : null
